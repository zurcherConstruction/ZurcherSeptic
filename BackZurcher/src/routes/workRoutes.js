...
// 🆕 Subir Notice to Owner
router.post('/:idWork/notice-to-owner', verifyToken, allowRoles(['admin', 'owner', 'worker']), upload.single('document'), invalidateWorkCache, WorkController.uploadNoticeToOwner);
