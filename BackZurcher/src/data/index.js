...
// CustomInvoice ↔ Work / SimpleWork
Work.hasMany(CustomInvoice, { foreignKey: 'workId', as: 'customInvoices' });
CustomInvoice.belongsTo(Work, { foreignKey: 'workId', as: 'linkedWork' });

SimpleWork.hasMany(CustomInvoice, { foreignKey: 'simpleWorkId', as: 'customInvoices' });
CustomInvoice.belongsTo(SimpleWork, { foreignKey: 'simpleWorkId', as: 'linkedSimpleWork' });
...
Reminder.hasMany(ReminderRead, { foreignKey: 'reminder_id', as: 'reads' });
ReminderRead.belongsTo(Reminder, { foreignKey: 'reminder_id' });
ReminderRead.belongsTo(Staff, { foreignKey: 'staff_id' });
...
NotificationRouting.belongsTo(Staff, { foreignKey: 'staff_id', as: 'staff' });
Staff.hasMany(NotificationRouting, { foreignKey: 'staff_id', as: 'notificationRoutings' });
